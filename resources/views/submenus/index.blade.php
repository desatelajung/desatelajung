        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    ...
                    <a href="{{ route('submenus.create') }}" class="btn btn-sm btn-outline-primary">Add</a>
                </div>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($submenus as $submenu)
                        <tr>
                            ...
                            <td>{{ $submenu->icon }}</td>
                            <td>
                                <a href="{{ route('submenus.show', $submenu->id) }}"
                                    class="text-info text-decoration-none me-2" title="Lihat"><i
                                        class="fas fa-eye"></i></a>
                                <a href="{{ route('submenus.edit', $submenu->id) }}"
