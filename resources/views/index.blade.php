...
@section('content')
    ...
    <script>
        // Mendapatkan referensi dari elemen canvas dengan id "myChart"
        var ctx = document.getElementById('myChart').getContext('2d');

        // Membuat data yang akan ditampilkan di grafik
        var data = {
        ...
        var options = {
            // Tambahkan opsi grafik di sini jika diperlukan
        };
        ...
        var myChart = new Chart(ctx, {
            ...
            options: options // Opsi konfigurasi grafik (opsional)
        });
    </script>
